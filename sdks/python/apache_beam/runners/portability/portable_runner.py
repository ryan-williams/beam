...
class PortableMetrics(MetricResults):
  def __init__(self, job_metrics_response):
    ...
    for monitoring_info in job_metrics_response.attempted:
      metric_key = monitoring_infos.metric_key(monitoring_info)
      if not monitoring_info.has_metric:
        continue
    ...
    for monitoring_info in job_metrics_response.committed:
      metric_key = monitoring_infos.metric_key(monitoring_info)
      if not monitoring_info.has_metric:
        continue
